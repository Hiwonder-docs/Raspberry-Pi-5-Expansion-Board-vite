# Raspberry-Pi-5-Expansion-Board Documentation

This repository contains the Raspberry-Pi-5-Expansion-Board VitePress documentation site. The
...
The staged production files are generated in `projects/Raspberry-Pi-5-Expansion-Board/en/latest/`.
...
```text
https://hiwonder-docs.github.io/Raspberry-Pi-5-Expansion-Board-vite/projects/Raspberry-Pi-5-Expansion-Board/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/Raspberry-Pi-5-Expansion-Board/en/latest/
```
